...
class CostCentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cost_center" do
    assert_difference('CostCenter.count') do
      post cost_centers_url, params: { cost_center: { account_id: @cost_center.account_id, details: @cost_center.details, number: @cost_center.number } }
    end
  ...
  test "should update cost_center" do
    patch cost_center_url(@cost_center), params: { cost_center: { account_id: @cost_center.account_id, details: @cost_center.details, number: @cost_center.number } }
