...
class TownsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create town" do
    assert_difference('Town.count') do
      post towns_url, params: { town: { classification: @town.classification, name: @town.name } }
    end
  ...
  test "should update town" do
    patch town_url(@town), params: { town: { classification: @town.classification, name: @town.name } }
